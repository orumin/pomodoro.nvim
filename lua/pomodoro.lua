...
---@field start fun(self: Pomodoro)
---@field stop fun(self: Pomodoro)
---@field statusline fun(self: Pomodoro):string
---@field status fun(self: Pomodoro)
---@field setup fun(self: Pomodoro)
local Pomodoro = {
  opts = config,
  ui = ui,
  state = "stopped",
...
function Pomodoro:status()
  vim.notify(self:statusline(), vim.log.levels.INFO, {title = "pomodoro.nvim"})
end
